...
def headExtraction3d():
    ...
    o3d.io.write_point_cloud("3D_Head clean.ply", inlier_cloud)
...
def faceMeshLandmarks3d():
    facial()
    # self.load('scaled_landmarks.ply')


def faceExtraction3d():
...
def leftFaceRegion():
 ...
 # LeftFace()
    Face = o3d.io.read_point_cloud("leftface_region.ply")
...
def rightFaceRegion():
  ...
  #  RightFace()
    ...
    Face = o3d.io.read_point_cloud("rightface_region.ply")
...
def imageLandmarks():
    ...
    def front(body):
        ...
        vis.run()  # User picks points
        vis.capture_screen_image("outputs/3d_models/image-body-front.jpg", do_render=True)
        vis.destroy_window()
    ...
    image_front = cv2.imread('outputs/3d_models/image-body-front.jpg')
    ...
    def detectSelectedPoseWithNames(image, pose, selected_indices, landmark_names):
        ...
        cv2.imwrite('outputs/3d_models/Frontimage.jpg', output_image)
        cv2.waitKey(0)
