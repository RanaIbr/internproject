...
def bodyLandmarks3d():
    ...
    with open("outputs/text_files/body.txt", mode='w') as f:
    ...
    data = np.loadtxt("outputs/text_files/body.txt")
    colors1 = np.loadtxt("outputs/text_files/colors1.txt")
    pcd = o3d.geometry.PointCloud()
    pcd.points = o3d.utility.Vector3dVector(data)
    pcd.colors = o3d.utility.Vector3dVector(colors1)

    o3d.io.write_point_cloud("outputs/3d_models/3D_body.ply", pcd)
    pcd_2 = o3d.io.read_point_cloud("outputs/3d_models/3D_body.ply")
    ...
    vis.run()  # user picks points
    vis.capture_screen_image("outputs/images/image-body.jpg", do_render=True)
    vis.destroy_window()
    ...
    image = cv2.imread('outputs/images/image-body.jpg')
    landmarks_2d = detectPose(image, pose, 'outputs/text_files/pose_landmarks.txt')
