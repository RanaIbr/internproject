...
def facial():
    ...
    o3d.io.write_point_cloud("landmarks.ply", pcd1)

    # Read point clouds
    body = o3d.io.read_point_cloud("3D_Head clean.ply")
    body1 = o3d.io.read_point_cloud("landmarks.ply")
    ...
    with open("scaled_landmarks.txt", mode='w') as f:
    ...
    data2 = np.loadtxt("scaled_landmarks.txt")
    pcdext = o3d.io.read_point_cloud("scaled_landmarks.txt", format="xyz")
    o3d.io.write_point_cloud("scaled_landmarks.ply", pcdext)
    mesh2 = o3d.io.read_point_cloud("scaled_landmarks.ply")
    ...
    o3d.io.write_point_cloud("face_region.ply", face_region)
    mesh2 = o3d.io.read_point_cloud("face_region.ply")
    ...
    Face = o3d.io.read_point_cloud("Face.ply")
    # Visualize the cropped face region
    ...
    o3d.io.write_point_cloud("leftface_region.ply", face_region_left)
    o3d.io.write_point_cloud("rightface_region.ply", face_region_right)
    mesh2 = o3d.io.read_point_cloud("leftface_region.ply")
    mesh3 = o3d.io.read_point_cloud("rightface_region.ply")
    # print(dir(mesh2))
...
def LandmarksFacee():
    ...
    # Read point clouds
    body = o3d.io.read_point_cloud("3D-Head clean.ply")
    body1 = o3d.io.read_point_cloud("landmarks.ply")
    R = body1.get_rotation_matrix_from_xyz((0, np.pi, np.pi))
    body1.rotate(R, center=(0, 0, 0))
