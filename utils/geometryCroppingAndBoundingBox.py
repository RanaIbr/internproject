...
def geometryCroppingAndBoundingBox():
    demo_crop_geometry()

    # Read the point cloud
    body = o3d.io.read_point_cloud("outputs/3d_models/clean.ply")
    head = o3d.io.read_point_cloud("outputs/3d_models/cropped_1.ply")
    ...
    vis.run()
    vis.capture_screen_image("outputs/images/image-front.png", do_render=True)
    vis.destroy_window()
