...
def facialMarks3d(file):
    ...
    cv2.imwrite('outputs/images/annotated_image.jpg', annotated_image)
    ...
    # 3D visualization
    pcd = open3d.io.read_point_cloud('outputs/text_files/landmarks.txt', format='xyz')
    ...
    pcdext = o3d.io.read_point_cloud("outputs/text_files/landmarks.txt", format="xyz")
    o3d.io.write_point_cloud("outputs/3d_models/landmarks.ply", pcdext)
    mesh = o3d.io.read_point_cloud("outputs/3d_models/landmarks.ply")
